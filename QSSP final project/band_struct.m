addpath('path_to_mystartdefaults');
run('mystartdefaults.m'); % Contains SI physical constants
...
compute_dos = false;
CohenBergstresser1966; % Load pseudopotential parameters for SC
...
G_aux = zeros(4, 1); % Auxiliary vector
for jj = 1:Gcut
  for ii = 1:Gcut
